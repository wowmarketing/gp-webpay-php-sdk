...
class PaymentRequest
{
     ...
     * @param string|null $repeatedPayment  "R" for "master payment" registration
     */
    public function __construct(int $orderNumber, float $amount, int $currency, int $depositFlag, string $url, string $merOrderNumber = null, string $repeatedPayment = null)
    {
        ...
        if ($repeatedPayment) {
            $this->params['USERPARAM1'] = $repeatedPayment;
        }
